...
public class InternalAuditor implements Runnable {
	private static final int MAXSLEEPTIME = 4500;
	...
	// Constructor 
	public InternalAuditor(BankAccount shared1, BankAccount shared2, String name)
	{
